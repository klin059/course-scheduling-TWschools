...
def create_zhes_scheduling_problem_inputs():
    ...
    # record number of homerooms (item) for each  grade (key), e.g. there are 6 homeroom classes for grade 6
    grade_to_nHomeroom_dict = {'G1':7, 'G2':5, 'G3': 5, 'G4':5,'G5':6, 'G6':6}

    # define the subjects and number of periods per week for each grade 
    ...
    # these exceptions are for the split and merge requirements
    ...
    subjectroom_to_subjects_dict = {'English room':['English(extra)'],'Music room 2':['Music', 'Music(extra)'], 'Music room 1':['Music', 'Music(extra)'],
                                  ...
                                  'Sport field-4':['PE'], 'Sport field-5':['PE'], 'Sport field-6':['PE'], 'Computer room': ['Computer'], 'Resource room':['Social']}  
    ...
    # create an arbitary homeroom for split-and-merge classes
    ...
    # subject teachers - each subject teacher only teach certain subjects
    # Use list of (grade,subject) tuples to define the subjects the teacher can teach
    ...
    # get list of tuples of (teacher name, grade, homeroom no, subject) for later populating teacher objects 
    ...
    # get list of tuples for later populating teacher objects
    ...
    # manually create "Peter" - the English teacher who will teach the additional split-and-merged English course
    ...
    # populate course to teacher and room to course tuples in status 
    status.populate_course_to_teacher_tuples()
    # note that one should only populate room_to_course_tuples after all allowed_homeroom are set
